...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select().apis(RequestHandlerSelectors.basePackage("com.marcio.springbootapi.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do curso Spring Boot",
				...
				new Contact("Marcio da Silva Santos", "https://github.com/marcioworks", "marcioadsworks@gmail.com"),
